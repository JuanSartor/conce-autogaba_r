 ...
 */
	 ...
	 */
	 ...
	 class TokenAga{
		 ...
		 public function obtenerTokenAga(){
        require('http.php');
         ...
         */
        $client->client_id = 'b16329f960c08429ad4b7b98be8ddb107c4b5d669de130b0e770e3e21e544f3e';

        /* OAuth client secret
         * Set this to values defined by the OAuth server for your application
         */
        $client->client_secret = 'd7feef5226d59f0d1401d851ca3c731fd300d84a7d010bbe94fd286dd4c68f97';
        ...
        if ($success) {
             ...
             */
            //  $client->Output();
            // echo  strlen($client->access_token);
            return HtmlSpecialChars($client->access_token);
        } else {
            return 0;
            /*
