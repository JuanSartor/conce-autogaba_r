...
$sql="SELECT id,descripcion,observaciones,eliminado FROM medios_contacto";
				...
				<tr style="background-color: white;">
				   ...
				   ?> </td>
					...
					<?php } 
						...
						<td> 
						<span class="btn btn-warning btn-sm" data-toggle="modal"   data-target="#modalEditar" onclick="actualizarMedio('<?php echo $mostrar[0] ?>')">
						<span class="fas fa-edit "></span>
						</span>
						</td>  
							<td>
						<span class="btn btn-danger btn-sm" onclick="eliminarDatosMedio('<?php echo $mostrar[0] ?>')">
							<span class="fas fa-trash-alt"></span>
						</span>
					</td> 
...
$("table").tableExport({
	...
	fileName: "Medios de Contacto al <?php echo $fechaDeHoy;?>",    //Nombre del archivo 
});
</script>
