...
<br>
<form  id="formularioOrdenPreventa" name="formularioOrdenPreventa" action="generarOrdenPreventaPDF.php"  method="post" onsubmit="return generandoOrdenPreVenta();" >
<div class="row container">
...
<?php 
	...
	$conexionEntidadCaja= conectar();
	mysqli_set_charset($conexionEntidadCaja,'utf8'); 
	$sqlcaja= "SELECT * from cajas";

	$resultadoEntidadCaja=mysqli_query($conexionEntidadCaja,$sqlcaja);

	mysqli_close($conexionEntidadCaja);
	...
	<!-- 	<div class="col-sm-2">
		...
		<label style="font-size: 13px">Caja:</label>
	</div>
	<div class="col-sm-1" >
<select id="idCaja" name="idCaja" style="background-color: gainsboro; " required="true" >
				<?php

				while ($valoresEntidadCaja = mysqli_fetch_array($resultadoEntidadCaja)) {
					?>
					<option value="<?php print($valoresEntidadCaja['id']);?>"> <?php  print($valoresEntidadCaja['nombre']);?> </option>
...
<div class="col-sm-2">
 ...
 <input type="button" value="Calcular Saldo" id="btnCalcularSaldo"  name="btnCalcularSaldo" style="height: 30px; border-radius: 6px; font-size: 12px; background-color:  darkseagreen;" onclick= "calcularSaldo();" />
</div>
...
<br>
    <br>
<div style="width: 400px; text-align: center"  class="col-sm-8 "   >
                <button   onsubmit=""   disabled="true"  class="btn btn-info" id="btnGenerarOrdenPreVenta" name="btnGenerarOrdenPreVenta"  style="margin-left: 100%" >Guardar Pre-Venta</button>
            </div>




<input type="hidden" id="valorVendedor" name="valorVendedor" value="0">
<input type="hidden" id="valorMedio" name="valorMedio" value="0">
<input type="hidden" id="salddoApagar" name="salddoApagar" value="0">
<input type="hidden" id="valorCliente"  name="valorCliente"  value="0">
<input type="hidden" id="valorVehiculo" name="valorVehiculo" value="0">


<input type="hidden" id="listaVehiculoCanje" name="listaVehiculoCanje" value="0">
<input type="hidden" id="listaChequesEntregados" name="listaChequesEntregados" value="0">



<input type="hidden" id="valorCheckCreditoPrendario" name="valorCheckCreditoPrendario" >
<input type="hidden" id="valorMontoPrendario" name="valorMontoPrendario" value="0">
<input type="hidden" id="valorMontoSellado" name="valorMontoSellado" value="0">
<input type="hidden" id="valorCheckCreditoPersonal" name="valorCheckCreditoPersonal" >
<input type="hidden" id="valorMontoPersonal" name="valorMontoPersonal" value="0">

<input type="hidden" id="idEntidadCreditoPrendario" name="idEntidadCreditoPrendario" value="-1">
<input type="hidden" id="idEntidadCreditoPersonal" name="idEntidadCreditoPersonal" value="-1">
<input type="hidden" id="valorFechaCargaPreVenta" name="valorFechaCargaPreVenta" value="0">

<input type="hidden" id="valorCheckboxUsado" name="valorCheckboxUsado" value="0">
<input type="hidden" id="valorCheckboxCheques" name="valorCheckboxCheques" value="0">

<input type="hidden" id="autosSeleccionadosComoCanje" name="autosSeleccionadosComoCanje">
...
<script type="text/javascript">
                $(document).ready(function() {
                	...
                	if(<?php echo $_SESSION['permisos'];?> =='3' && <?php echo $banderaAcceso;?> !='1' ){
