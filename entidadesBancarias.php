                         ...
                         <!--    <li class="nav-item">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-8" class="collapse submenu show" >
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="#">Entidades Bancarias</a>
                                        </li>
                                        <!-- <li class="nav-item">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#tablaDatatable').load('tablaEntidadesBancarias.php');
    });
...
function eliminarDatosEntidad(id){
    alertify.confirm('Eliminar Entidad', '¿Esta seguro que desea eliminar la entidad?',
        function(){ 
                $.ajax({
        type:"POST",
        data:"id=" + id,
        url:"procesos/eliminarEntidad.php",
        success:function(r){
