                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                           ...
                           <!--   <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="#"  aria-expanded="false" data-target="#submenu-7" aria-controls="submenu-7"><i class="fas fa-registered"></i>Aprobar Pre-Ventas</a>
        ...
        <div class="row">
            ...
            <div class="col-sm-1" > 
               <select id="filSelect" name="filSelect" class="mi-selectorVehiculos">
                  ...
                  <option  value="en">En Revision</option>
...
function aprobarPreVenta(id){
  
    alertify.confirm('Aprobar PreVenta', '¿Esta seguro que desea Aprobar esta orden?',
        function(){ 
                $.ajax({
        type:"POST",
        data:"id=" + id,
...
function revisarPreVenta(id){
  
  alertify.confirm('Revisar PreVenta', '¿Esta seguro que desea poner a Revisar esta orden?',
      function(){ 
              $.ajax({
      type:"POST",
      data:"id=" + id,
...
function rechazarPreVenta(id){
  
  alertify.confirm('Rechazar PreVenta', '¿Esta seguro que desea Rechazar esta orden?',
      function(){ 
              $.ajax({
      type:"POST",
      data:"id=" + id,
...
function decidirPreVenta(id){
  window.location.href='detallePreVenta.php?datos='+btoa(id) +'&datos33='+btoa(1);
...
$(document).ready(function(){
    $("select[name=filSelect]").change(function(){
        ...
        var load='tablaPreVentasRevision.php?pme='+ $('select[name=filSelect]').val();
