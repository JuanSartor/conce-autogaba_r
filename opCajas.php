                                    ...
                                    <ul class="nav flex-column">
                                       ...
                                       <!--  <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                         ...
                                         <li class="nav-item">
                                            <a class="nav-link" href="#">Operaciones de Cajas</a>
                                        </li>
...
<form id="frmnuevo" onsubmit="nuevoConsumo()"  action="" method="post">
    ...
    <input type="text" class="form-control input-sm" id="descripcionConsumo" name="descripcionConsumo" required maxlength="39" minlength="4" pattern="^[a-zA-Z\s]+">
     <label>Caja</label>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#tablaDatatable').load('tablaOpCajas.php');
    });
