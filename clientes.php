...
<form id="frmnuevo" onsubmit="nuevoCliente()"  action="" method="post">
    ...
    <label id="razonSocialLabel" hidden="true">Razon Social <label style="color: red;">*</label></label>
    <input style="text-transform: capitalize;" type="text"  class="form-control input-sm" id="razonSocial" name="razonSocial" required minlength="4" maxlength="59" disabled="true" hidden="true">
       <label id="cuitLabel"  hidden="true">Cuit <label style="color: red;">*</label></label>
    <input style="text-transform: capitalize;" type="text"  class="form-control input-sm" id="cuit" name="cuit" required minlength="4" maxlength="24" disabled="true" hidden="true"  pattern="[0-9]+">
...
mysqli_close($conexionVe);
     ...
     ?> 
     <br>
    <div class="row" id="filaVendedor">
		<div class="col-sm-2" >
		<label >Vendedor: </label>
		</div>
		<div class="col-sm-4" >
<select style="width: 300px; "  id="idVendedor"   name="idVendedor" class="mi-selectorVendedor"   required="true">
				<?php
...
<div class="modal fade" id="modalEditar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <label id="nombreLabelU" >Nombre <label style="color: red;">*</label></label>
    ...
    <label id="razonSocialLabelU" >Razon Social <label style="color: red;">*</label></label>
    <input style="text-transform: capitalize;" type="text"  class="form-control input-sm" id="razonSocialU" name="razonSocialU" required minlength="4" maxlength="59"  >
       <label id="cuitLabelU"  >Cuit <label style="color: red;">*</label></label>
    <input style="text-transform: capitalize;" type="text"  class="form-control input-sm" id="cuitU" name="cuitU" required minlength="4" maxlength="24"    pattern="[0-9]+">
    ...
    <label>Localidad</label>
    <input style="text-transform: capitalize;" type="text" class="form-control input-sm" id="localidadU" name="localidadU"  minlength="4" maxlength="24">
    <label>Provincia</label>
    <input style="text-transform: capitalize;" type="text" class="form-control input-sm" id="provinciaU" name="provinciaU"  minlength="4" maxlength="24">    
    <label>Email</label>
...
$conexionVee= conectar();
mysqli_set_charset($conexionVee,'utf8'); 
$sqlvee= "SELECT id,nombre,apellido,dni from usuarios where permisos='vendedor' and eliminado='NO'
 order by LENGTH(nombre) desc";

$resultadoVee=mysqli_query($conexionVee,$sqlvee);

mysqli_close($conexionVee);

     ?> 
     <br>
    <div class="row" id="filaVendedorE">
		<div class="col-sm-2" >
		<label >Vendedor: </label>
		</div>
		<div class="col-sm-4" >
<select style="width: 300px; "  id="idVendedorE"   name="idVendedorE" class="mi-selectorVendedorE"   required="true">
				<?php

				while ($valoresVe = mysqli_fetch_array($resultadoVee)) {
					?>
                    <option    value="<?php print($valoresVe['id']);?>"> 
                    <?php  print($valoresVe['nombre']); print(" ");print($valoresVe['apellido']); print(" ");print($valoresVe['dni']);?> </option>
    ...
    <input type="text" hidden class="form-control input-sm" id="idVendedorParaE" name="idVendedorParaE">
    <input type="text" hidden class="form-control input-sm" id="idRegClieVend" name="idRegClieVend">           
...
document.getElementById('idVendedorPara').value=document.getElementById('idVendedor').value;
}
...
function actualizarGuardarCliente(){
    ...
    if('<?php echo $_SESSION["permisos"];?>'!='3' ){
        document.getElementById("idVendedorParaE").value= document.getElementById("idVendedorE").value;
            }
            else{
                document.getElementById("idVendedorParaE").value='<?php echo $_SESSION["idC"];?>';
    ...
    $.ajax({
        ...
        success:function(r){
            ...
            $('#apellidoU').val(' ');
               ...
               document.getElementById("apellidoLabelU").hidden=true;
               document.getElementById("apellidoU").hidden=true;
               document.getElementById("nombreLabelU").hidden=true;
               document.getElementById("nombreU").hidden=true;
               document.getElementById("dniLabelU").hidden=true;     
               document.getElementById("dniU").hidden=true;

            $('#razonSocialU').val(datos['razonSocial']);
            $('#cuitU').val(datos['cuit']);

               document.getElementById("razonSocialLabelU").hidden=false;
                  document.getElementById("cuitLabelU").hidden=false;
                     document.getElementById("razonSocialU").hidden=false;
                        document.getElementById("cuitU").hidden=false;
            ...
            document.getElementById("dniU").hidden=false;
            document.getElementById("dniLabelU").hidden=false;
            document.getElementById("nombreU").hidden=false;
            document.getElementById("nombreLabelU").hidden=false;
            document.getElementById("apellidoU").hidden=false;
            document.getElementById("apellidoLabelU").hidden=false;



            $('#razonSocialU').val(' ');
            document.getElementById("razonSocialU").hidden=true;
            document.getElementById("razonSocialLabelU").hidden=true;

            $('#cuitU').val('0');
            document.getElementById("cuitU").hidden=true;
            document.getElementById("cuitLabelU").hidden=true;

            }

            
            $('#domicilioU').val(datos['direccion']);
            $('#localidadU').val(datos['localidad']);
            ...
            if('<?php echo $_SESSION["permisos"];?>'!='3' ){
            $('#idVendedorE').select2("val", datos['idVendedor']); }
            else{
                document.getElementById("filaVendedorE").hidden=true;

            }

            $('#idRegClieVend').val(datos['idRegiClVen']);
