                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-8" class="collapse submenu show" >
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" href="#">Creditos Personales</a>
                                        </li>
                                        <li class="nav-item">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#tablaDatatable').load('tablaCreditosPersonales.php');
    });
...
function aceptarCredito(id){
    alertify.confirm('Aceptar Credito', '¿Esta seguro que desea Aceptar este credito?',
        ...
        type:"POST",
        data:"id=" + id,
        url:"procesos/aprobarCreditoPersonal.php",
        success:function(r){
...
function cancelarCredito(id){
    alertify.confirm('Cancelar Credito', '¿Esta seguro que desea Cancelar este credito?',
        ...
        type:"POST",
        data:"id=" + id,
        url:"procesos/cancelarCreditoPersonal.php",
        success:function(r){
