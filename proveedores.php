...
<form id="frmnuevo" onsubmit="nuevaProveedor()"  action="" method="post">
    ...
    <input type="text" class="form-control input-sm" id="observaciones" name="observaciones"  minlength="4" maxlength="79">
...
<div class="modal fade" id="modalEditar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="frmactualizar"  onsubmit="actualizarGuardarProveedor()"  action="" method="post">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#tablaDatatable').load('tablaProveedores.php');
    });
...
function actualizarGuardarProveedor(){
...
function eliminarDatosProveedor(id){
    alertify.confirm('Eliminar Proveedor', '¿Esta seguro que desea eliminar este proveedor ?',
        function(){ 
                $.ajax({
        type:"POST",
        data:"id=" + id,
