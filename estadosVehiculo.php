                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-8" class="collapse submenu show" >
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" href="#">Estados de Vehiculos</a>
                                        </li>
                                        <li class="nav-item">
...
<form id="frmnuevo" onsubmit="nuevoEstado()"  action="" method="post">
...
<div class="modal fade" id="modalEditar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="frmactualizar"  onsubmit="actualizarGuardarEstado()"  action="" method="post">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#tablaDatatable').load('tablaEstados.php');
    });
...
<script type="text/javascript">
    function nuevoEstado(){
        ...
        $.ajax({
            type:"POST",
            data:datos,
            url:"procesos/agregarEstado.php",
            success:function(){
...
function actualizarGuardarEstado(){
        datos=$('#frmactualizar').serialize();
        $.ajax({
            type:"POST",
            data:datos,
            url:"procesos/actualizarEstado.php",
            success:function(){
...
function eliminarDatosEstado(id){
    alertify.confirm('Eliminar Estado', '¿Esta seguro que desea eliminar este estado de Vehiculo ?',
        function(){ 
                $.ajax({
        type:"POST",
        data:"id=" + id,
        url:"procesos/eliminarEstado.php",
        success:function(r){
