                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-8" class="collapse submenu show" >
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" href="#">Lista Gastos Vehiculo</a>
                                        </li>
                                         <li class="nav-item">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#tablaDatatable').load('tablaGastosVehiculo.php');
    });
...
function eliminarDatosGastos(id){
    alertify.confirm('Eliminar Gasto', '¿Esta seguro que desea eliminarlo?',
        function(){ 
                $.ajax({
        type:"POST",
        data:"id=" + id,
        url:"procesos/eliminarGasto.php",
        success:function(r){
