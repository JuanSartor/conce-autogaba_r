                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" style="background-color: lightsteelblue;"  aria-expanded="false" data-target="#submenu-7" aria-controls="submenu-7"><i class="fas fa-money-bill-wave"></i>Movimientos Varios</a>
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-8" class="collapse submenu" >
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/icon-weather.html">Tipos de Vehiculos</a>
                                        </li>
                                         <li class="nav-item">
...
<div class="modal fade" id="agregarnuevosdatosmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <form id="frmnuevo" onsubmit="nuevoConsumo()"  action="" method="post">


        <?php 

    $conexionProveedor= conectar();
    mysqli_set_charset($conexionProveedor,'utf8'); 
    $sqlP= "SELECT * from proveedores order by LENGTH(descripcion) desc";

    $resultadoProveedores=mysqli_query($conexionProveedor,$sqlP);

    mysqli_close($conexionProveedor);
    
         ?>


    <label>Fecha <label style="color: red;">*</label></label>
    <input type="date" class="form-control input-sm" id="fechaing" name="fechaing" required  value="<?php echo date("Y-m-d"); ?>">
    <br>
  
    <div class="row">
        <div class="col-sm-3" >
    <label >Proveedor <label style="color: red;">*</label></label>
</div>
  <div class="col-sm-6" >
    <select  id="idTipoProveedor"   name="idTipoProveedor" class="mi-selectorProveedor"   required="true">
                <?php
    ...
    <input type="text" class="form-control input-sm" id="montoConsumo" name="montoConsumo" required maxlength="39" minlength="1" pattern="[0-9]+(\.[0-9]{1,2})?%?">
    <label>Descripcion <label style="color: red;">*</label></label>
    <input type="text" class="form-control input-sm" id="descripcionConsumo" name="descripcionConsumo" required minlength="4">
...
<div class="modal fade" id="modalEditar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <input style="text-transform: capitalize;" type="text" class="form-control input-sm" id="domicilioU" name="domicilioU" required minlength="4" maxlength="24">
    <label>Localidad</label>
    <input style="text-transform: capitalize;" type="text" class="form-control input-sm" id="localidadU" name="localidadU" required minlength="4" maxlength="24">
    <label>Provincia</label>
    <input style="text-transform: capitalize;" type="text" class="form-control input-sm" id="provinciaU" name="provinciaU" required minlength="4" maxlength="24">    
    <label>Email</label>
    <input type="email" class="form-control input-sm" id="correoU" name="correoU" required minlength="4" maxlength="24">
     <label>Telefono</label>
    <input type="text" class="form-control input-sm" id="telefonoU" name="telefonoU" required minlength="4" maxlength="24">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#tablaDatatable').load('tablaConsumos.php');
    });
...
<script type="text/javascript">
    function nuevoConsumo(){
        ...
        $.ajax({
            type:"POST",
            data:datos,
            url:"procesos/agregarConsumo.php",
            success:function(){
...
function eliminarDatosConsumo(id){
    alertify.confirm('Eliminar consumo', '¿Esta seguro que desea eliminar el consumo?',
        function(){ 
                $.ajax({
        type:"POST",
        data:"id=" + id,
        url:"procesos/eliminarConsumo.php",
        success:function(r){
