                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-8" class="collapse submenu show" >
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" href="#">Tipos de Vehiculos</a>
                                        </li>
                                         <li class="nav-item">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Nuevo Tipo Vehiculo</h5>
...
<form id="frmnuevo" onsubmit="nuevoTipoVehiculo()"  action="" method="post">
    <label>Descripcion <label style="color: red;">*</label></label>
    <input type="text" class="form-control input-sm" id="descripcion" name="descripcion" required minlength="2" maxlength="49">
    <label>Observaciones</label>
    <input type="text" class="form-control input-sm" id="observaciones" name="observaciones"  minlength="4" maxlength="99">
...
<div class="modal fade" id="modalEditar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Actualizar Tipo Vehiculo</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form id="frmactualizar"  onsubmit="actualizarGuardarTipo()"  action="" method="post">
    

	<label>Descripcion <label style="color: red;">*</label></label>
    <input type="text" class="form-control input-sm" id="descripcionU" name="descripcionU" required minlength="2" maxlength="49">
    <label>Observaciones</label>
    <input type="text" class="form-control input-sm" id="observacionesU" name="observacionesU"  minlength="4" maxlength="69">
	<input type="text" hidden="true" class="form-control input-sm" id="idU" name="idU"  minlength="4" maxlength="99">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#tablaDatatable').load('tablaTiposVehiculo.php');
    });
...
<script type="text/javascript">
    function nuevoTipoVehiculo(){
        ...
        $.ajax({
            type:"POST",
            data:datos,
            url:"procesos/agregarTipoVehiculo.php",
            success:function(){
...
function actualizarGuardarTipo(){
        datos=$('#frmactualizar').serialize();
        $.ajax({
            type:"POST",
            data:datos,
            url:"procesos/actualizarTipo.php",
            success:function(){
...
function actualizarTipo(id){
    $.ajax({
        type:"POST",
        data:"id=" + id,
        url:"procesos/obtenerDatosTipoVehiculo.php",
        success:function(r){
...
function eliminarDatosTipo(id){
    alertify.confirm('Eliminar Tipo Vehiculo', '¿Esta seguro que desea eliminar este Tipo de Vehiculo ?',
        function(){ 
                $.ajax({
        type:"POST",
        data:"id=" + id,
        url:"procesos/eliminarTipo.php",
        success:function(r){
