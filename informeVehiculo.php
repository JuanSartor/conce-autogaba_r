...
<head>
    ...
    $sqlProEsta= "SELECT vehiculos.marca,vehiculos.modelo, vehiculos.dominio_patente  from vehiculos where id='$_GET[datosidPp]'";
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#tablaDatatable').load('tablaDetalleSobrVehiculo.php?datosidPp='+"<?php echo $_GET['datosidPp']; ?>");
