                                ...
                                <div id="submenu-8" class="collapse submenu show" >
                                    <ul class="nav flex-column">
                                      ...
                                      <!--   <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" href="#">Alojamientos de Vehiculos</a>
                                        </li>
                                        <li class="nav-item">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Nuevo Lugar</h5>
...
<form id="frmnuevo" onsubmit="nuevoLugar()"  action="" method="post">
...
<div class="modal fade" id="modalEditar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="frmactualizar"  onsubmit="actualizarGuardarLugar()"  action="" method="post">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#tablaDatatable').load('tablaLugares.php');
    });
...
function actualizarGuardarLugar(){
        datos=$('#frmactualizar').serialize();
        $.ajax({
            type:"POST",
            data:datos,
            url:"procesos/actualizarLugar.php",
            success:function(){
...
function actualizarLugar(id){
    $.ajax({
        type:"POST",
        data:"id=" + id,
        url:"procesos/obtenerDatosLugar.php",
        success:function(r){
...
function eliminarDatosLugar(id){
    alertify.confirm('Eliminar Lugar', '¿Esta seguro que desea eliminar este lugar de alojamiento?',
        function(){ 
                $.ajax({
        type:"POST",
        data:"id=" + id,
        url:"procesos/eliminarLugar.php",
        success:function(r){
