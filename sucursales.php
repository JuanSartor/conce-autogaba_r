...
<form id="frmnuevo" onsubmit="nuevaSucursal()"  action="" method="post">
    <label>Descripcion <label style="color: red;">*</label></label>
    <input type="text" class="form-control input-sm" id="descripcion" name="descripcion" required minlength="2" maxlength="59">
    <label>Domicilio</label>
    <input type="text" class="form-control input-sm" id="observaciones" name="observaciones"  minlength="4" maxlength="59">
...
<div class="modal fade" id="modalEditar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="frmactualizar"  onsubmit="actualizarGuardarSucursal()"  action="" method="post">
...
function actualizarGuardarSucursal(){
        datos=$('#frmactualizar').serialize();
        $.ajax({
            type:"POST",
            data:datos,
            url:"procesos/actualizarSucursal.php",
            success:function(){
...
function actualizarSucursal(id){
    $.ajax({
        type:"POST",
        data:"id=" + id,
        url:"procesos/obtenerDatosSucursal.php",
        success:function(r){
...
function eliminarDatosSucursal(id){
    alertify.confirm('Eliminar Sucursal', '¿Esta seguro que desea eliminar esta sucursal ?',
        function(){ 
                $.ajax({
        type:"POST",
        data:"id=" + id,
        url:"procesos/eliminarSucursal.php",
        success:function(r){
