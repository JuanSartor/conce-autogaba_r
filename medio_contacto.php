                                       ...
                                       <!--  <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                         ...
                                         <li class="nav-item active">
                                            <a class="nav-link active" href="#">Medios de Contacto</a>
                                        </li>
                                        <li class="nav-item">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Nuevo Medio</h5>
...
<form id="frmnuevo" onsubmit="nuevoMedio()"  action="" method="post">
    <label>Descripcion <label style="color: red;">*</label></label>
    <input type="text" class="form-control input-sm" id="descripcion" name="descripcion" required minlength="2" maxlength="249">
    <label>Observaciones</label>
    <input type="text" class="form-control input-sm" id="observaciones" name="observaciones"  minlength="4" maxlength="249">
  ...
  <div class="modal-footer">
        ...
        <button type="submit" id="btnAgregarNuevo" class="btn btn-primary" >Crear Nueva</button>
      </div>
...
<div class="modal fade" id="modalEditar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Actualizar Medio</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form id="frmactualizar"  onsubmit="actualizarGuardarMedio()"  action="" method="post">
    

	<label>Descripcion <label style="color: red;">*</label></label>
    <input type="text" class="form-control input-sm" id="descripcionU" name="descripcionU" required minlength="2" maxlength="249">
    <label>Observaciones</label>
    <input type="text" class="form-control input-sm" id="observacionesU" name="observacionesU"  minlength="4" maxlength="249">
	<input type="text" hidden="true" class="form-control input-sm" id="idU" name="idU"  minlength="4" maxlength="79">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#tablaDatatable').load('tablaMedioContacto.php');
    });
...
<script type="text/javascript">
    function nuevoMedio(){
        ...
        $.ajax({
            type:"POST",
            data:datos,
            url:"procesos/agregarMedioContacto.php",
            success:function(){
...
function actualizarGuardarMedio(){
        datos=$('#frmactualizar').serialize();
        $.ajax({
            type:"POST",
            data:datos,
            url:"procesos/actualizarMedioContacto.php",
            success:function(){
...
function actualizarMedio(id){
    $.ajax({
        type:"POST",
        data:"id=" + id,
        url:"procesos/obtenerDatosMedioContacto.php",
        success:function(r){
...
function eliminarDatosMedio(id){
    alertify.confirm('Eliminar Medio', '¿Esta seguro que desea eliminar este medio de contacto ?',
        function(){ 
                $.ajax({
        type:"POST",
        data:"id=" + id,
        url:"procesos/eliminarMedioContacto.php",
        success:function(r){
