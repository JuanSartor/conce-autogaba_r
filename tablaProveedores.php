...
$sql="SELECT id,descripcion,observaciones,eliminado FROM proveedores";
				...
				<tr style="background-color: white;">
				   ...
				   ?> </td>
					...
					<?php } 
						...
						<td> 
						<span class="btn btn-warning btn-sm" data-toggle="modal"   data-target="#modalEditar" onclick="actualizarProveedor('<?php echo $mostrar[0] ?>')">
						<span class="fas fa-edit "></span>
						</span>
						</td>  
							<td>
						<span class="btn btn-danger btn-sm" onclick="eliminarDatosProveedor('<?php echo $mostrar[0] ?>')">
							<span class="fas fa-trash-alt"></span>
						</span>
					</td> 
...
$("table").tableExport({
	...
	fileName: "Proveedores al <?php echo $fechaDeHoy;?>",    //Nombre del archivo 
});
</script>
