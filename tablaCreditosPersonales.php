...
// $sql="select ventas.id,creditos_personal.id,creditos_personal.monto,
// creditos_personal.estado,entidades_prendarias.descripcion 
// from entidades_prendarias,creditos_personal,
// (SELECT operacion_preventa.id,operacion_preventa.id_personal FROM vehiculos,clientes,
...
// where ventas.id=pag.id_orden_preventa ) and creditos_personal.id=ventas.id_personal 
// and creditos_personal.id_entidad=entidades_prendarias.id ";

$sql="SELECT o.id,c.id,c.monto,c.estado,e.descripcion,v.dominio_patente 
from entidades_prendarias e,creditos_personal c,operacion_preventa o, vehiculos v
where c.id=o.id_personal and c.id_entidad=e.id and (c.estado='0' or c.estado='1') and o.id_vehiculo_prevendido=v.id";
			...
			<tbody>
				...
				<tr style="background-color: white;">
				    ...
				    <td style="font-size: 12px"> <?php 
						...
						elseif($mostrar[3]=='1'){echo "<div class=\"alert alert-success\" role=\"alert\" style=\"height:35px\" >Otorgado</div> "; }
...
$("table").tableExport({
	...
	fileName: "Creditos Personales al <?php echo $fechaDeHoy;?>",    //Nombre del archivo 
});
</script>
