...
$sql="SELECT id,descripcion,domicilio,eliminado FROM sucursales";
	...
	<table class="table table-hover table-condensed table-bordered" id="iddatatable">
		...
		<thead  style="background-color:#ccc; color: white; font-weight: bold; ">
			<tr>
				...
				<td style="font-size: 12px">Domicilio</td>
				...
				<tr style="background-color: white;">
				   ...
				   ?> </td>
					...
					<?php } 
						...
						<td> 
						<span class="btn btn-warning btn-sm" data-toggle="modal"   data-target="#modalEditar" onclick="actualizarSucursal('<?php echo $mostrar[0] ?>')">
						<span class="fas fa-edit "></span>
						</span>
						</td>  
							<td>
						<span class="btn btn-danger btn-sm" onclick="eliminarDatosSucursal('<?php echo $mostrar[0] ?>')">
							<span class="fas fa-trash-alt"></span>
						</span>
					</td> 
...
$("table").tableExport({
	...
	fileName: "Sucursales al <?php echo $fechaDeHoy;?>",    //Nombre del archivo 
});
</script>
