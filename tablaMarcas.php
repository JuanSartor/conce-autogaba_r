...
$sql="SELECT id,descripcion,observaciones,eliminado FROM marcas";
				...
				<tr style="background-color: white;">
				   ...
				   ?> </td>
					...
					<?php } 
						...
						<td> 
						<span class="btn btn-warning btn-sm" data-toggle="modal"   data-target="#modalEditar" onclick="actualizarMarca('<?php echo $mostrar[0] ?>')">
						<span class="fas fa-edit "></span>
						</span>
						</td>  
							<td>
						<span class="btn btn-danger btn-sm" onclick="eliminarDatosMarca('<?php echo $mostrar[0] ?>')">
							<span class="fas fa-trash-alt"></span>
						</span>
					</td> 
...
$("table").tableExport({
	...
	fileName: "Marcas al <?php echo $fechaDeHoy;?>",    //Nombre del archivo 
});
</script>
