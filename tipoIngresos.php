                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-8" class="collapse submenu show" >
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" href="#">Tipos de Ingresos</a>
                                        </li>
                                        <li class="nav-item">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Nuevo Tipo de Ingreso</h5>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#tablaDatatable').load('tablaTipoIngresos.php');
    });
...
<script type="text/javascript">
    function nuevaEntidad(){
        ...
        $.ajax({
            type:"POST",
            data:datos,
            url:"procesos/agregarTipoIngreso.php",
            success:function(){
...
function actualizarGuardarEntidad(){
        ...
        $.ajax({
            type:"POST",
            data:datos,
            url:"procesos/actualizarTipoIngreso.php",
            success:function(){
...
function actualizarTipoIngreso(id){
    $.ajax({
        type:"POST",
        data:"id=" + id,
        url:"procesos/obtenerDatosTipoIngreso.php",
        success:function(r){
...
function eliminarDatosEntidad(id){
    alertify.confirm('Eliminar Tipo Ingreso', '¿Esta seguro que desea eliminar este tipo?',
        function(){ 
                $.ajax({
        type:"POST",
        data:"id=" + id,
        url:"procesos/eliminarTipoIngreso.php",
        success:function(r){
