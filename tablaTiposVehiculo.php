...
$sql="SELECT id,descripcion,observaciones,eliminado FROM tipos_vehiculos";
				...
				<tr style="background-color: white;">
				   ...
				   ?> </td>
					...
					<?php } 
						...
						<td> 
						<span class="btn btn-warning btn-sm" data-toggle="modal"   data-target="#modalEditar" onclick="actualizarTipo('<?php echo $mostrar[0] ?>')">
						<span class="fas fa-edit "></span>
						</span>
						</td>  
							<td>
						<span class="btn btn-danger btn-sm" onclick="eliminarDatosTipo('<?php echo $mostrar[0] ?>')">
							<span class="fas fa-trash-alt"></span>
						</span>
					</td> 
...
$("table").tableExport({
	...
	fileName: "Tipos de Vehiculos al <?php echo $fechaDeHoy;?>",    //Nombre del archivo 
});
</script>
